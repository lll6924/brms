...
array[M_4] vector[N] Z_aggregated;
Z_aggregated[1] = Z_4_1;
Z_aggregated[2] = Z_4_2;
}
parameters {
...
model {
  ...
  if (!prior_only) {
    ...
    for (n in 1:N) {
      ...
      mu[n] += r_1_1[J_1[n]] * Z_1_1[n] + r_1_2[J_1[n]] * Z_1_2[n] + r_2_1[J_2[n]] * Z_2_1[n] + r_2_2[J_2[n]] * Z_2_2[n] + r_3_1[J_3[n]] * Z_3_1[n];
    }
    for (n in 1:N) {
      // add more terms to the linear predictor
    ...
    sigma = exp(sigma);
    target += normal_id_glm_multi_marginalized_lpdf(Y | Xc, mu, b, sigma, J_4, N_4, M_4, sd_4, L_4, Z_aggregated);
  }
...
generated quantities {
  ...
  z_4 = normal_id_glm_multi_marginalized_recover_rng(Y, Xc, mu, b, sigma, J_4, N_4, M_4, sd_4, L_4, Z_aggregated);
}
